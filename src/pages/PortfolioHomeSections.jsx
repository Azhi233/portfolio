...
export function PortfolioHero({ t }) {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pt-10 md:px-12 md:pt-14">
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.9, ease: 'easeOut' }} className="relative z-10 mx-auto max-w-6xl text-center">
        <p className="text-[11px] uppercase tracking-[0.34em] text-[#151515]/45">Cinematic Visuals for Industry & Product</p>
        <h1 className="mt-5 text-5xl font-light tracking-[0.08em] md:text-8xl">{t('home.heroTitle', 'Your Name')}</h1>
        <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-[#151515]/60 md:text-base">A quiet visual portfolio built around large imagery, minimal text, and highly curated motion.</p>
      </motion.div>
    </section>
  );
}
